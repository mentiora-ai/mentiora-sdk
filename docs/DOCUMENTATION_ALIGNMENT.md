...
**Types:**
- ✅ `TraceEvent` - Both documented with all fields
- ✅ `TraceError` - Both documented
- ✅ `SendTraceResult` - Both documented (fixed TypeScript to match)
- ✅ `TraceType` - Both documented
- ✅ `Environment` - Both documented
...
- ✅ Plugin options - Both documented
...
| Environment | `environment` | `environment` | ✅ Aligned |
| Project ID | `projectId` | `project_id` | ✅ Aligned |
