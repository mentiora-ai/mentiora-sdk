...
const config: Config = {
  title: 'Mentiora SDK',
  tagline: 'Official SDK for the Mentiora platform - tracing, vector DB, and more',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Mentiora. Built with Docusaurus.`,
    },
    prism: {
